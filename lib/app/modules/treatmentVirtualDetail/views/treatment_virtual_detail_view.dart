...
class TreatmentVirtualDetailView extends GetView<TreatmentVirtualDetailController> {
  const TreatmentVirtualDetailView({Key? key}) : super(key: key);
  @override
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              Column(
                children: [
                  ...
                  Text(
                    ...
                    style: AppStyle.styleTextBody20(fontWeight: FontWeight.bold, colorText: AppColors.blue),
                  ...
                  Text(
                    '120 Menit',
                    style: AppStyle.styleTextBody14(colorText: AppColors.blue),
                  ),
                ],
              ...
              ).marginSymmetric(horizontal: 20, vertical: 10).marginOnly(bottom: 50),
            ],
          ),
        ));
  }
